...
import by.ealipatov.kotlin.materialyoufromealipatov.databinding.FragmentCoordinatorLayoutBinding
...
class CoordinatorLayoutFragment: Fragment() {
    ...
    override fun onCreateView(
        ...
        _binding = FragmentCoordinatorLayoutBinding.inflate(inflater)
        return binding.root
    }
